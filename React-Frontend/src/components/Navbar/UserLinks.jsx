            ...
            <AnimatePresence>
                {dropDownState && (
                    ...
                    >
                        ...
                        <Link onClick={(e) => setDropDownState(false)} to="/history" className={`${navLinkBaseClass} mt-1`}>
                            <span>History</span>
                        ...
                        <Link onClick={(e) => setDropDownState(false)} to="/bookmarks" className={`${navLinkBaseClass} mt-1`}>
                            <span>Bookmarks</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className="h-4 w-4">
                        ...
                        <Link onClick={(e) => setDropDownState(false)} to="/logout" className={`${navLinkBaseClass} text-red-600 hover:bg-red-50 hover:text-red-700`}>
                            <span>Logout</span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.75} stroke="currentColor" className="h-4 w-4">
